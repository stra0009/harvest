...
def main_logic
  ...
  # Send embeds using Net::HTTP directly to avoid discordrb issues
  ...
  tasks.each do |task|
    embed_hash = {
      ...
      'fields' => [
        ...
        { 'name' => "元メッセージ", 'value' => (task['original_context'] || "N/A").to_s[0..1000] } # Truncate
      ],
    ...
    req['Content-Type'] = 'application/json'
    req.body = { embeds: [embed_hash] }.to_json
