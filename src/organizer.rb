...
def main_logic
  ...
  begin
    uri = URI("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=#{GEMINI_API_KEY}")
  ...
  embeds = tasks.map do |task|
    {
      ...
      fields: [
        { name: "優先度", value: task['priority'] || "普通", inline: true },
        { name: "元メッセージ", value: task['original_context'] || "N/A" }
      ],
